export default function(context: any) {
  const { storagePath, path, fs, axios } = context;

async function localizeMarkdownImageLinks(markdownContent: any, docId: any, sourceUrl: any) {
...
function downloadDataUriAsset(dataUri: any, outputDir: any, imageIndex: any) {
...
function resolveAbsoluteImageUrl(source: any, sourceUrl: any) {
...
function isDataUri(value: any) {
  return /^data:image\//i.test(String(value || '').trim());
}

function determineImageExtension(source: any, contentType: any) {
...
function mimeTypeToExtension(contentType: any) {
