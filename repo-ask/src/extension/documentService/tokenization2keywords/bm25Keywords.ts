 ...
 */
function buildCorpus(docIds: any, readContent: any, tokenize: any) {
 ...
 * @returns {string[]}
 */
function scoreDocumentBm25(docId: any, corpus: any, { k1 = 1.2, b = 0.75, topN = 20 }: any = {}) {
...
export { buildCorpus, scoreDocumentBm25
};
